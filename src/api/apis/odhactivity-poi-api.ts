...
export const ODHActivityPoiApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [categorycodefilter] CategoryCode Filter (Only for ODHActivityTypes of type Gastronomy) (BITMASK) refers to &lt;a href&#x3D;\&quot;https://tourism.opendatahub.bz.it/v1/GastronomyTypes?rawfilter&#x3D;eq(Type,\\\&quot;CategoryCodes\\\&quot;)\&quot; target&#x3D;\&quot;_blank\&quot;&gt;GastronomyTypes&lt;/a&gt;, Type: CategoryCodes
         * @param {string} [dishcodefilter] DishCode Filter (Only for ODHActivityTypes of type Gastronomy) (BITMASK) refers to &lt;a href&#x3D;\&quot;https://tourism.opendatahub.bz.it/v1/GastronomyTypes\&quot; target&#x3D;\&quot;_blank\&quot;&gt;GastronomyTypes&lt;/a&gt;, Type: DishCodes
         * @param {string} [ceremonycodefilter] CeremonyCode Filter (Only for ODHActivityTypes of type Gastronomy) (BITMASK) refers to &lt;a href&#x3D;\&quot;https://tourism.opendatahub.bz.it/v1/GastronomyTypes\&quot; target&#x3D;\&quot;_blank\&quot;&gt;GastronomyTypes&lt;/a&gt;, Type: CeremonyCodes
         * @param {string} [facilitycodefilter] FacilityCode Filter (Only for ODHActivityTypes of type Gastronomy) (BITMASK) refers to &lt;a href&#x3D;\&quot;https://tourism.opendatahub.bz.it/v1/GastronomyTypes\&quot; target&#x3D;\&quot;_blank\&quot;&gt;GastronomyTypes&lt;/a&gt;, Type: with FacilityCodes_ prefix
         * @param {string} [cuisinecodefilter] CuisineCode Filter (Only for ODHActivityTypes of type Gastronomy) (BITMASK) refers to &lt;a href&#x3D;\&quot;https://tourism.opendatahub.bz.it/v1/GastronomyTypes\&quot; target&#x3D;\&quot;_blank\&quot;&gt;GastronomyTypes&lt;/a&gt;, Type: CuisineCodes
