...
<template>
  <div class="d-flex flex-column w-100">
    ...
    <div v-else-if="item" class="d-flex flex-column rounded-4 shadow overflow-hidden">
...
import { Detail, Measuringpoint, ODHActivityPoiLinked, SkiAreaLinked } from '@/api/models';
